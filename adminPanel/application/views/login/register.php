...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Already registered?</span> <a href="<?=base_url()?>login" class="btn btn-danger">Sign In</a> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src="<?=base_url()?>assets/img/demo/iphoneview.png" alt="" class="pull-right display-image" style="width:210px">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="index.html" id="smart-form-register" class="smart-form client-form">
								<header>
